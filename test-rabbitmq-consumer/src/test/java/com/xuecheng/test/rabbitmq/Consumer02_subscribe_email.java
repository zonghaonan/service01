...
public class Consumer02_subscribe_email {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //监听队列
            //参数：String queue, boolean autoAck, String consumerTag, Consumer callback
            /*
             * 参数明细：
             * 1、query 队列名称
             * 2、autoAck 自动回复，当消费者接受到消息后要告诉mq消息已接收，如果将此参数设置为true表示自动回复mq,如果设置为false要通过编程实现回复
